...
The complete architecture of the Vision Transformer can be found in ```docs``` folder and look for [VIT_ARCHITECTURE.md](https://github.com/laureimei/dissertation-vit-fer/blob/main/docs/VIT_ARCHITECTURE.md)
